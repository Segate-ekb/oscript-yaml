...
&Тег("folded")
&Тег("scalar")
&Выключен("Парсинг отступов в блочных скалярах")
...
&Тег("scalar")
&Тег("1_3_err")
&Выключен("Неправильная обработка отступов в свернутых блоках")
...
&Тег("folded")
&Тег("scalar")
&Выключен("Неправильная обработка отступов в блочных скалярах")
...
&Тег("indent")
&Тег("whitespace")
&Выключен("Неправильная обработка табуляции")
...
&Тег("whitespace")
&Тег("double")
&Выключен("Неправильная обработка табуляции в строках")
...
&Тег("error")
&Тег("flow")
&Выключен("Не обрабатывается ошибка комментария после запятой")
...
&Тег("spec")
&Тег("scalar")
&Выключен("Неправильная обработка обрезки конечных строк")
...
&Тег("directive")
&Выключен("Не обрабатывается ошибка лишних слов в YAML директиве")
...
&Тег("alias")
&Тег("1_3_err")
&Выключен("Ошибка обработки символов в алиасах")
...
&Тег("folded")
&Тег("error")
&Выключен("Не обрабатывается ошибка неправильного отступа")
...
&Тег("literal")
&Тег("scalar")
&Выключен("Не обрабатывается ошибка неправильных модификаторов")
...
&Тег("directive")
&Тег("error")
&Выключен("Не обрабатывается ошибка дублированной YAML директивы")
...
&Тег("double")
&Тег("error")
&Выключен("Не обрабатывается ошибка неправильного отступа в маппинге")
...
&Тег("sequence")
&Тег("flow")
&Выключен("Неправильная обработка якорей в последовательностях")
...
&Тег("comment")
&Тег("error")
&Выключен("Не обрабатывается ошибка комментария как ключа маппинга")
...
&Тег("directive")
&Тег("error")
&Выключен("Не обрабатывается ошибка директивы без документа")
...
&Тег("error")
&Тег("flow")
&Выключен("Не обрабатывается ошибка пропущенной запятой в flow")
...
&Тег("scalar")
&Тег("error")
&Выключен("Не обрабатывается ошибка лишних пробелов в блочных скалярах")
...
&Тег("whitespace")
&Тег("error")
&Выключен("Не обрабатывается ошибка табуляции в отступах маппинга")
...
&Тег("footer")
&Тег("error")
&Выключен("Не обрабатывается ошибка содержимого после маркера конца документа")
...
&Тег("whitespace")
&Тег("scalar")
&Выключен("Неправильная обработка keep модификатора блочного скаляра")
...
&Тег("directive")
&Выключен("Не обрабатывается ошибка неправильных вариантов директив")
...
&Тег("mapping")
&Тег("alias")
&Выключен("Ошибка обработки алиасов в неявных блочных маппингах")
...
&Тег("spec")
&Тег("scalar")
&Выключен("Неправильная обработка обрезки финального переноса строки")
...
&Тег("whitespace")
&Выключен("Не обрабатывается ошибка табуляции в различных контекстах")
...
&Тег("whitespace")
&Выключен("Неправильная обработка табуляции в различных контекстах")
...
&Тег("literal")
&Выключен("Неправильная обработка завершающих пробелов в потоках")
...
&Тег("scalar")
&Тег("1_3_err")
&Выключен("Неправильная обработка свернутых строк и финальных пустых строк")
...
&Тег("whitespace")
&Тег("error")
&Выключен("Не обрабатывается ошибка лишних пробелов в первой строке")
...
&Тег("alias")
&Тег("whitespace")
&Выключен("Неправильная обработка пробелов вокруг двоеточия в маппингах")
...
&Тег("error")
&Тег("flow")
&Выключен("Не обрабатывается ошибка пропущенной запятой в flow маппинге")
...
&Тег("scalar")
&Тег("1_3_err")
&Выключен("Неправильная обработка блочного свертывания")
...
&Тег("error")
&Тег("header")
&Выключен("Не обрабатывается ошибка якоря на строке начала документа")
...
&Тег("edge")
&Тег("1_3_err")
&Выключен("Неправильная обработка якорей с двоеточием в имени")
...
&Тег("error")
&Тег("flow")
&Выключен("Не обрабатывается ошибка неявного ключа с переносом строки")
...
&Тег("whitespace")
&Тег("sequence")
&Выключен("Неправильная обработка индикаторов отступа")
...
&Тег("folded")
&Тег("scalar")
&Выключен("Неправильная обработка заголовка блочного скаляра")
...
&Тег("sequence")
&Тег("error")
&Выключен("Не обрабатывается ошибка якоря перед элементом последовательности")
