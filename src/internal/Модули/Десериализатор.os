...
Функция НайтиУправляющийСимволИЕгоПозицию(Строка)
...
Функция ПозицияНеЭкранированногоСимвола(Строка, ИскомыйСимвол)
    ...
    Для Позиция = 1 По СтрДлина(Строка) Цикл
        ...
        Если НЕ ВКавычках И Символ = ИскомыйСимвол Тогда
            Если ЭтоЗначащийСимвол(Строка, Позиция, ЭтоМногострочнаяСтрока) Тогда
...
//
Функция ЭтоЗначащийСимвол(Строка, Позиция, МногострочнаяСтрока = Ложь)
...
Функция ПолучитьМассивСущностей(Строки)
    ...
    Для Индекс = 0 По Строки.Количество() - 1 Цикл
        ...
        Если ДанныеУправляющегоСимвола.Символ = ":" Тогда // Это объект
            ...
            Если НайтиУправляющийСимволИЕгоПозицию(МодифицированнаяСтрока).Позиция > 0 Тогда
